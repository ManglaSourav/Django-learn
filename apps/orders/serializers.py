...
class OrderSerializer(TimeStampedSerializer):
    ...
    class Meta:
        ...
        fields = (
            ...
            'billing_last_name', 'billing_full_name', 'billing_email', 'billing_phone',
            ...
            'notes', 'tracking_number', 'shipped_at', 'delivered_at', 'items',
            'can_be_cancelled', 'can_be_refunded', 'created_at', 'updated_at'
        )
        read_only_fields = (
            'id', 'order_number', 'subtotal', 'tax_amount', 'shipping_amount',
            'discount_amount', 'total_amount', 'shipped_at', 'delivered_at',
            'created_at', 'updated_at'
        )
...
class OrderStatusHistorySerializer(TimeStampedSerializer):
    ...
    class Meta:
        ...
        fields = (
            'id', 'status', 'notes', 'changed_by', 'changed_by_email',
            'created_at', 'updated_at'
        )
...
class CartSerializer(TimeStampedSerializer):
    ...
    class Meta:
        model = Cart
        fields = (
            'id', 'items', 'total_items', 'total_amount', 'created_at', 'updated_at'
        )
        read_only_fields = ('id', 'created_at', 'updated_at')
...
class CartItemCreateSerializer(serializers.ModelSerializer):
    ...
    def create(self, validated_data):
        ...
        if 'product_variant_id' in validated_data and validated_data['product_variant_id']:
            variant = ProductVariant.objects.get(
                id=validated_data['product_variant_id'],
                product=product,
                is_active=True
            )
            unit_price = variant.price
