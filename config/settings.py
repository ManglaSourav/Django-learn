"""
Django settings for production-ready backend system.
"""
...
ALLOWED_HOSTS = config(
    'ALLOWED_HOSTS', default='localhost,127.0.0.1,0.0.0.0,testserver').split(',')
...
THIRD_PARTY_APPS = [
    ...
    'health_check',
    'health_check.db',
    # 'health_check.cache',  # Disabled - requires Redis
...
CORS_ALLOWED_ORIGINS = config(
    'CORS_ALLOWED_ORIGINS', default='http://localhost:3000,http://127.0.0.1:3000').split(',')
...
# Celery Configuration (disabled - no Redis)
...
# Silk profiling (only in DEBUG mode)
if DEBUG:
